    ...
    <header>
        <nav>
            <ul class="items-header">
                <a href="/view/listaUsuario.php">
                    <li class="btn-nav">Consultar clientes</li>
                </a>
                <a href="/view/listaLivro.php">
                    <li class="btn-nav">Consultar Livros</li>
                </a>
                <a href="/view/listaAlocacao.php">
            ...
            <form class="formulario" action="processaEdicaoAlocacao.php" method="post">
                <div class="inputs-cadastros">
                    <div>
                        ...
                        <input class="entrada" type="text" name="idUsuario" value="<?= $Alocacao['clientes_id'] ?>" required>
                        <label>*idLivro:</label>
                        <input class="entrada" type="text" name="idLivro" value="<?= $Alocacao['livros_id'] ?>" required>
                    </div>
                </div>
